...
if (isset($terminos)){
	...
	$stmt = $mysqli->prepare("INSERT INTO $tableName(alias, contrasena, correo) VALUES (?, ?, ?)");
...
if ($result) {
	echo "Usuario añadido correctamente. Redirigiendo a la pagina de inicio...";
	header("refresh:5;url=http://localhost/practicaRA3/solid/index.php");
}else{
	echo "error, no se ha podido añadir el usuario. Redirigiendo...";
	header("refresh:5;url=http://localhost/practicaRA3/solid/registroUsuario.php");
}
?>
