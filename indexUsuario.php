				...
				<nav class="navbar navbar-default navbar-fixed-top">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a  input type="button" href="#" onclick="location.href='http://localhost/practicaRA3/solid/mensajeUsuario.php'"><span>Mensajes</span></a>
							<li><a  input type="button" href="#" onclick="location.href='http://localhost/practicaRA3/solid/perfilUsuario.php'"><span>Perfil</span></a>
							</li>
